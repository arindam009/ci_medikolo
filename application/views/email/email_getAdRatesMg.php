<table cellpadding="0" cellspacing="0" width="100%" style="width:100%; margin:0 auto;" align="center">
  <tr>
    <td style="padding-top:36px; padding-bottom:0; background:#f3f3f3;"><table width="574" align="center" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="background:#fff;"><table>
              ...
              <tr>
                <td bgcolor="#fff" style="padding:0px 0 26px 0;text-align:center;font:normal 12px Arial, Helvetica, sans-serif;color:#605f5f;line-height:18px;">&nbsp;</td>
              </tr>
              <tr>
                <td bgcolor="#fff" style="padding:5px;text-align:left; font:normal 12px Arial, Helvetica, sans-serif;color:#464646; line-height:18px;">
                  <p>Magazine : {magazine}</p>
                  <p>Category : {category}</p>
                  <p>Target group : {target_group}</p>
                  <p>Mobile : {phone}</p></td>
              </tr>
              <tr>

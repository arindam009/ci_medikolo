                ...
                <td style="background:#fff;"><table>
                    ...
                    <tr>
                      <td><table width="100%">
                          ...
                          <tr>
                            <td width="100%" style="font:normal 12px Arial, Helvetica, sans-serif;padding:5px 0;color:#3E3E3E;text-align:left; padding:10px;">
                            Please remit an amount of Rs {amount} against Order ID {final_order_id} via NEFT to the following bank account details within 24 hours so that we can
                            process your order:
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <table width="100%">
                                <tr>
                                  <td bgcolor="#f7f7f7" style="border:1px solid #ddd;">

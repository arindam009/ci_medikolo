          ...
          <td style="padding-top:10px;"><table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background:#fff;"><table>
                    ...
                    <tr>
                      <td bgcolor="#fff" style="padding:12px 0 15px 0;text-align:center;">&nbsp;</td>
                    </tr>
                    <tr>
                      <td bgcolor="#fff" style="padding:12px 0 15px 0;text-align:center;">Please note that this order is incomplete and can be completed on BookAllAds. Please complete the order to publish your ad.</td>
                    </tr>
                    <tr>
                      <td bgcolor="#fff" style="padding:12px 0 15px 0;text-align:center;">&nbsp;</td>
                    </tr>

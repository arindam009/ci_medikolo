<table cellpadding="0" cellspacing="0" width="100%" style="width:100%; margin:0 auto;" align="center">
  <tr>
    <td style="padding-top:20px; padding-bottom:200px; background:#f3f3f3;"><table width="574" align="center" cellpadding="0" cellspacing="0" border="0">
        <tr>
          <td style="background:#fff;"><table>
              ...
              <tr>
                <td bgcolor="#fff"><table width="100%" border="0" cellpadding="2" cellspacing="4" style="padding:23px 0 15px 0;text-align:left;font:normal 12px Arial, Helvetica, sans-serif;color:#333;">
                    <tr>
                      <td >A new user has just signup useing </td>
                    </tr>
                    <tr>

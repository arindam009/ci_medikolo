		...
		<div class="wrap clearfix">
			...
			<nav class="breadcrumbs">
				<ul>
					...
					<li> Blog \ </li>
					<li> Category \ </li> 
					<li> <?php echo $category_data['category']->cat_name;?></li>
				</ul>
			</nav>
			<!--//breadcrumbs-->
			...
			<div class="row">
				<header class="s-title pull-left">
					<h1><?php echo $category_data['category']->cat_name;?></h1>
				</header>
				...
				<section class="content three-fourth">
					...
					<?php 
					/*echo "<pre>";
					print_r($category_data['blog']);
					echo "</pre>";*/
					foreach($category_data['blog'] as $res_blog) 
					{ 
					?>
					<article class="post">
						...
						<div class="container">
							...
							<div class="entry-content">
								...
								<p>
								<?php echo string_limit_words(strip_tags($res_blog->blog_description),50);?>
								</p>
							</div>
							<div class="actions">
								<div>
									...
									<div class="comments"><i class="fa fa-comment"></i><a href="<?php echo base_url()?>blog/<?php echo $res_blog->slug;?>#comments">
										<?php 
									$CI =& get_instance();
									...
									<div class="leave_comment"><a href="<?php echo base_url()?>blog/<?php echo $res_blog->slug;?>#respond">Leave a comment</a></div>

					...
					<article class="post">
						...
						<div class="container">
							...
							<div class="entry-content">
								<h2><a href="<?php echo base_url()?>blog/<?php echo $res_blog->slug;?>"><?php echo string_limit_words(strip_tags($res_blog->blog_name),10);?></a></h2>
								<p>									

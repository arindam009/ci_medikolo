                ...
                <div class="form-group">
                                    ...
                                    <label for="inputslidercaption">Shipping Class</label>
                                     ...
                                     <select name="shipping_class"  class="form-control" id="">
                                        ...
                                        <?php foreach ($all_shipping_class as $shipping) { 
                                           ...
                                           <option value="$shipping->id" <?php echo $selected;?>><?php echo $shipping->class_name;?></option>
                                    <?php    } ?>
                                     </select>
                            ...
                            <div class="tab-pane" id="seo">
                               <div class="form-group">
                                    ...
                                    <input name="meta_title"  value="" type="text" class="form-control" id="inputslidercaption" placeholder="Enter Meta Title" value="<?php echo $product_all->meta_title;?>">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input name="meta_keyword"  value="" type="text" class="form-control" id="inputslidercaption" placeholder="Enter Meta Keyword" value="<?php echo $product_all->meta_keywords;?>">
                               ...
                               <?php   }  ?>       
                                ...
                                <div class="form-group">
                                    ...
                                    <?php foreach ($product_gallery as $single_image) { ?>
                                         <img id="img" src="<?php echo base_url()?>uploads/product_image/<?php echo $single_image->image?>" height="100" width="100">
                                  <?php  } ?>

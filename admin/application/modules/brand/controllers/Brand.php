...
//==========================view =========================================
    ...
    {
		$data['data_all'] = $this->Crud_model->get_all_data('tbl_brand');

		$site_name=$this->config->item('site_name');
        $this->template->set('title', 'Brand | '.$site_name);
			...
			$data['slug'] = strtolower(trim(preg_replace('/[^A-Za-z0-9-]+/', '-', $data['title'])));
			 ...
			 $this->form_validation->set_rules('title', 'title', 'trim|required');
			  ...
			  if ($this->form_validation->run() == TRUE) {
                  ...
                  $data_inserted = $this->Crud_model->add_data('tbl_brand',$data);
...
/*================================ Edit advertise ===========================*/
	...
	public function edit($id)
    {
                       ...
                       // File Upload 1
                        ...
                        if (! $this->upload->do_upload()) {
                         ...
                         $error = array('error' => $this->upload->display_errors()); 
                            ...
                            $final_files_data_logo[] = $this->upload->data();
                            $data['logo_img']= $final_files_data_logo[0]['file_name'];
                            @unlink("../uploads/brand/".$this->input->post('prev_link_logo')."");
						}
                      ...
                      // File Upload 2
                        ...
                        if (! $this->upload->do_upload()) {
                         ...
                         $error = array('error' => $this->upload->display_errors()); 
                            ...
                            $final_files_data_banner[] = $this->upload->data();
                            $data['banner_img']= $final_files_data_banner[0]['file_name'];
                            @unlink("../uploads/brand/".$this->input->post('prev_link_banner')."");
                        }
			         
            if ($this->form_validation->run() == TRUE) {

                $data_updated = $this->Crud_model->update_data('tbl_brand',$data,$id);
        ...
        $data_single = $this->Crud_model->get_data_by_id('tbl_brand',$id);
...
/*================================ Delete Data ===========================*/
	...
	public function delete_data($dataid)
    {
        ...
        {
        $data_single = $this->Crud_model->get_data_by_id('tbl_brand',$dataid);
        @unlink("../uploads/brand/".$data_single[0]->logo_img."");
        @unlink("../uploads/brand/".$data_single[0]->banner_img."");
        $this->Crud_model->empty_row_data('tbl_brand',$dataid);
...
/*===================== Inactive =======================================*/
	public function inactive($id)
    {
        ...
        {
               $data['status'] = '0';
               $data_inserted = $this->Crud_model->update_data('tbl_brand',$data,$id);
               $this->session->set_flashdata('success_msg', 'Data updated Successfully'); 
               redirect($_SERVER['HTTP_REFERER']);               
        }
    }

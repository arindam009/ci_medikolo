...

{
...

  {
	 ...
	 $this->db->select('tbl_recipe.id as recipe_id ,orderid,recipe_name, tbl_recipe.recipe_code,tbl_recipe.status as recpie_status,tbl_recipe.is_approved,tbl_recipe.feature_image,tbl_difficulty.name as dificulty_name');
  ...
  function delete_instruction_by_recipecode($id)

	{

		 $this->db->where('recipe_code', $id);
   		$this->db->delete('tbl_recipe_instruction');

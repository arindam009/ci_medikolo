                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
								...
								<?php 
								 $i=1;
								 foreach($allcustomer_row as $alldata) { ?>
                                <tr class="">
                                <td><?php echo $i;?></td>
                                    ...
                                    <?php  if($alldata->is_feature_profile=="0") { ?>
                                    
                                    <a href="<?php echo base_url();?>admin/customer/featured/<?php echo $alldata->id;?>" class="btn btn-danger">Normal</a>
                                     <?php } else if($alldata->is_feature_profile=="1"){?>
                                       <a href="<?php echo base_url();?>admin/customer/normal/<?php echo $alldata->id;?>" class="btn btn-success">Featured </a>
                                     <?php } ?>
                                    ...
                                    <a href="<?php echo base_url();?>admin/customer/active/<?php echo $alldata->id;?>" class="btn btn-danger">Inactive </a>
                                     <?php } else if($alldata->status=="1"){?>
                                       <a href="<?php echo base_url();?>admin/customer/inactive/<?php echo $alldata->id;?>" class="btn btn-success">Active </a>
                                     <?php } ?>
                                       
                                    </td>
                                    <td>
                                    <a class="view_data" href="<?php echo base_url();?>admin/customer/viewcustomer/<?php echo $alldata->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 

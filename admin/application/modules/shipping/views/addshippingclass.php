  ...
  <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Add Shipping Class <a href="<?php echo base_url();?>admin/shipping/viewshippingclass" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="class_name" type="text" value="<?php echo set_value('class_name'); ?>" class="form-control" placeholder="Enter Shipping class Name">

                            ...
                            <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                                ...
                                <tr class="">
                                    ...
                                    <td><?php echo $alldata->title;?></td>
                                     <td><?php echo $alldata->heading_title;?></td>
                                       <td><?php echo $alldata->meta_title;?></td>
                                    <td><a class="edit_data" href="<?php echo base_url();?>admin/pages/editpages/<?php echo $alldata->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid,dataimg)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>admin/pages/delete_data/"+dataid+'/'+dataimg;
    }
  }
</script>      
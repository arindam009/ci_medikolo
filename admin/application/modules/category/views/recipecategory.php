                    ...
                    <div class="alert alert-danger">
                      ...
                      <?php } ?>
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url()?>admin/category/addrecipecategory">
...
function orderser(ordrval,orderid){
	...
	var ordrvalue = ordrval;
		...
		success:function(data){
			...
			window.location.href= '<?php echo base_url(); ?>admin/category/recipe';
								...
								<?php  if($single_category->status=="1") { $stat="Active";} else {$stat="Inactive";} ?>
                                 <td><?php echo $i?></td>
                                  <td><input name="orderfld[]" id="orderfld[]" type="text" value="<?php echo $single_category->orderid;?>"  style="width:35px; text-align:center;" onBlur="orderser(this.value,<?php echo $single_category->id;?>);"/></td>
                                    ...
                                    <td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/category/editrecipe/<?php echo $single_category->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid,dataimg)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>admin/category/delete_recipe/"+dataid+'/'+dataimg;
    }
  }
</script>      
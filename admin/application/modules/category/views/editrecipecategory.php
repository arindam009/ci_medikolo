  ...
  <?php } ?>
                    ...
                    <section class="panel">
                        ...
                        <header class="panel-heading">
                           ...
                           <h3> Edit Category <a href="<?php echo base_url();?>admin/category/recipe" class="btn btn-danger flotright">Back</a></h3>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="form-group">
                                   ...
                                   <label for="inputslidercaption">Category Icon</label>
                                    ...
                                    <input name="cat_icon" type="text" class="form-control" value='<?php echo $single_category->cat_icon;?>'>

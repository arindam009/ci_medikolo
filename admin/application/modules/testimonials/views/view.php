                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                ...
                                <div class="btn-group pull-right">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url()?>admin/testimonials/add">
       ...
       <table class="table table-striped table-bordered nowrap" id="tabledata" style="width:100%;">
                   ...
                   <tbody>
								...
								<td><?php echo $i;?></td>
                                   ...
                                   <a href="<?php echo base_url();?>admin/testimonials/active/<?php echo $res_data->id;?>" class="btn btn-danger">Inactive 
                                   </a>
                                    <?php } else if($res_data->status==1){?>
                                       <a href="<?php echo base_url();?>admin/testimonials/inactive/<?php echo $res_data->id;?>" class="btn btn-success">Active </a>
                                     <?php } ?>
									...
									<td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/testimonials/edit/<?php echo $res_data->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 

                    ...
                    <section class="panel">
                        <header class="panel-heading">
                           <h3>
                            <?php if($current_data==0){?> Add <?php } else {?> Edit <?php } ?>
                             Department
                            <a href="<?php echo base_url();?>admin/department/" class="btn btn-danger flotright">Back</a>
                           </h3>
                        </header>
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="logo_img" accept="image/*"  />
                                         ...
                                         <img class="featuredimg" src="<?php echo base_url()?>uploads/department/<?=$single_row_data[0]->logo_img?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="banner_img"  accept="image/*" />
                                         ...
                                         <img class="featuredimg" src="<?php echo base_url()?>uploads/department/<?=$single_row_data[0]->banner_img?>">
								...
								<div class="form-group">
                                     <label for="inputslidercaption">Featured Home</label>
                                     <select name="featured_home" class="form-control">
                                         
										 
										 <option value="1" <?php if($single_row_data[0]->featured_home==1){echo "selected";} ?>>Featured</option>
										 
                                         <option value="0" <?php if($single_row_data[0]->featured_home==0){echo "selected";}?>>Disappeared</option>

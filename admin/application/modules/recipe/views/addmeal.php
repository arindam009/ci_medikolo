  ...
  <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Add Meal Type<a href="<?php echo base_url();?>admin/recipe/addmeal" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" value="<?php echo set_value('name'); ?>" class="form-control" placeholder="Enter Meal Name">

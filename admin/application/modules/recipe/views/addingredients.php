  ...
  <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                           <h3> Add Ingredients <a href="<?php echo base_url();?>admin/recipe/addingredients" class="btn btn-danger flotright">Back</a></h3>
                        </header>
                        <div class="panel-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" value="<?php echo set_value('name'); ?>" type="text" class="form-control" placeholder="Enter Ingredients Name">

                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                ...
                                <div class="btn-group pull-right">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url()?>admin/customers/add">
                   ...
                   <tbody>
								...
								<td><?php echo $i;?></td>
									<td><input name="orderfld[]" id="orderfld[]" type="text" value="<?php echo $res_data->orderid;?>"  style="width:35px; text-align:center;" onBlur="orderser(this.value,<?php echo $res_data->id;?>);"/></td>
                                      <td><?php echo $res_data->full_name;?></td>
                                      <td><?php echo $res_data->email;?></td>
									  <td><?php echo $res_data->mobile;?></td>
									  <td class="center">

                                    <?php  if($res_data->status==0) { ?>
                                    
                                   <a href="<?php echo base_url();?>admin/customers/active/<?php echo $res_data->id;?>" class="btn btn-danger">Inactive 
                                   </a>
                                    <?php } else if($res_data->status==1){?>
                                       <a href="<?php echo base_url();?>admin/customers/inactive/<?php echo $res_data->id;?>" class="btn btn-success">Active </a>
                                     <?php } ?>
                                       
                                    </td>
                                    <td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/customers/edit/<?php echo $res_data->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>admin/customers/delete_data/"+dataid;
    }
  }
</script>      
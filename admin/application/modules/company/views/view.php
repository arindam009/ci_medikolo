                        ...
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                ...
                                <div class="btn-group pull-right">
                                   <a id="editable-sample_new" class="btn btn-primary" href="<?php echo base_url()?>admin/company/add">
                   ...
                   <tbody>
								...
								<td><?php echo $i;?></td>
									<td><input name="orderfld[]" id="orderfld[]" type="text" value="<?php echo $res_data->orderid;?>"  style="width:35px; text-align:center;" onBlur="orderser(this.value,<?php echo $res_data->id;?>);"/></td>
									  ...
									  <td><?php echo $res_data->alt_email;?></td>
									  ...
									  <td class="img_data list_img_box">
                                        <img  src="<?php echo base_url()?>uploads/company_details/<?php echo $res_data->logo;?>">
                                      </td>
								      
									  <td class="img_data list_img_box">
                                        <img  src="<?php echo base_url()?>uploads/company_details/<?php echo $res_data->fav_icon;?>">
                                      </td>
                                   ...
                                   <a href="<?php echo base_url();?>admin/company/active/<?php echo $res_data->id;?>" class="btn btn-danger">Inactive 
                                   </a>
                                    <?php } else if($res_data->status==1){?>
                                       <a href="<?php echo base_url();?>admin/company/inactive/<?php echo $res_data->id;?>" class="btn btn-success">Active </a>
                                     <?php } ?>
									...
									<td>
                                    <a class="edit_data" href="<?php echo base_url();?>admin/company/edit/<?php echo $res_data->id;?>"><i class="fa fa-edit"></i></a> &nbsp; 
...
<script type="text/javascript">
  function myJsFunc_comdel(dataid)
  {
    ...
    {
    window.location.href = "<?php echo base_url()?>admin/company/delete_data/"+dataid;
    }
  }
</script>      
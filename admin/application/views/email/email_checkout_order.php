<table cellpadding="0" cellspacing="0" width="100%" style="width:100%; margin:0 auto;" align="center">
  <tr>
    <td style="padding-top:20px; padding-bottom:200px; background:#f3f3f3;"><table width="600" align="center" bgcolor="#f3f3f3" border="0" cellpadding="0" cellspacing="0" style="text-align:center;vertical-align:central;margin:0 auto;">
        <tr>
          <td style="padding-top:10px;"><table class="content" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="background:#fff;"><table>
                                ...
                                <tr>
                                  <td><table width="100%">
                                      <tr>
                                        ...
                                        <td style="font:bold 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#464646;text-align:left;">CHECKOUT ORDER ID</td>
                                      ...
                                      <tr>
                                        <td style="text-align:left;"><img src="{base_url}/themes/front/images/copy.png" /></td>
                                        <td style="font:bold 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#464646;text-align:left;">MOBILE</td>
                                        <td style="font:normal 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#9e9e9e;text-align:left;text-transform:uppercase;">{mobile}</td>
                                      </tr>
                                      
                                      <tr>
                                        <td style="text-align:left;"><img src="{base_url}/themes/front/images/copy.png" /></td>
                                        <td style="font:bold 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#464646;text-align:left;">USER</td>
                                        <td style="font:normal 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#9e9e9e;text-align:left;text-transform:uppercase;">{user}</td>
                                      </tr>
                                      <tr>
                                        <td style="text-align:left;"><img src="{base_url}/themes/front/images/copy.png" /></td>
                                        <td style="font:bold 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#464646;text-align:left;">USER ID</td>
                                        <td style="font:normal 11px Arial, Helvetica, sans-serif;padding:5px 0;color:#9e9e9e;text-align:left;text-transform:uppercase;">{user_id}</td>
                                      </tr>
                    ...
                    <tr>
                      <td bgcolor="#fff" style="padding:12px 0 15px 0;text-align:center;"><a style="background:#b51e23;text-align:center;padding:10px 30px 10px 20px;border-bottom:5px solid #a9191e; font:bold 14px Arial, Helvetica, sans-serif;color:#fff;text-transform:uppercase;text-decoration:none;" href="{base_url}/admin/checkout_orders">View Details</a></td>
                    </tr>
                    <tr>
                      <td bgcolor="#fff" style="padding:0px 0 26px 0;text-align:center;font:normal 12px Arial, Helvetica, sans-serif;color:#605f5f;line-height:18px;">BookAllAds is India's quickest and safest online Ad Portal and gives you access to unlimited advertising options and the best prices, deals, discounts and offers available all across India</td>
                    </tr>
                  </table>
